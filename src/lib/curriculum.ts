...
export const CURRICULUM: Curriculum = {
  lines: [
    {
      ...
      problem:
        "You arrive with some maths, some deep learning and no shared vocabulary for RL. The reading ahead assumes conditional expectation, gradients through stochastic objectives, a training loop you can debug, and a rough idea of which course covers what.",
      approach:
        "Two diagnostics and a set of companions. Test yourself on the maths and deep-learning checks and refresh only what fails. Then meet the textbook, the lecture series and the reference code once, here, so that later stations can send you to a chapter, a lecture or a file without introducing it again.",
      outcome:
        "You know which gaps you have and have closed the ones that matter. You can open Sutton & Barto, a Silver lecture or a CleanRL file and know where it sits in the whole.",
      closed: true,
      path: [
        [728, 598],
        [1716, 598],
      ...
      stations: [
        {
          ...
          outcome:
            "Write E[G_t | S_t = s] without hesitating, differentiate a log-likelihood, and say what a confidence interval does and does not claim.",
          resources: [
            {
              id: "p0-maths:1",
              kind: "book",
        ...
        },
        {
          ...
          outcome:
            "Write a training loop from scratch, read a loss curve, and tell a broken implementation apart from a badly tuned one before any of it is wrapped in an agent.",
          resources: [
            {
              id: "p0-dl:1",
              kind: "book",
    ...
    },
    {
      ...
      problem:
        "Orientation gave you the vocabulary and the sources but no algorithms. Every deep method later on is a tabular idea plus a function approximator, and a reader who skipped the tabular version cannot tell which half of a deep agent is failing.",
      approach:
        "Tabular RL end to end: bandits and regret, MDPs and dynamic programming, Monte Carlo and TD estimation, Q-learning and SARSA for control, Dyna for planning, n-step returns and eligibility traces, then the two cliffs, partial observability and the deadly triad, and the first policy gradient. An exercise follows each idea so that the implementation, not the reading, is what gets checked.",
      outcome:
        "You can implement any tabular method from its update rule, predict how two of them will differ on a task before running them, and explain why bootstrapping, off-policy data and approximation are dangerous together.",
      path: [
        [286, 988],
        [2054, 988],
      ],
      ...
      stations: [
        {
          ...
          outcome:
            "Derive the UCB bonus, implement UCB and Thompson sampling, and plot cumulative regret against a fixed baseline.",
          landmark: true,
          resources: [
            {
              id: "p8-bandits:1",
        ...
        },
        {
          ...
          outcome:
            "Write the Bellman expectation and optimality equations for a small MDP and say why value iteration converges.",
          landmark: true,
          resources: [
            {
              id: "p1-dp:1",
        ...
        },
        {
          ...
          outcome:
            "Derive the ratio for a trajectory, say why its variance grows with the horizon, and recognise it when it reappears in a deep RL objective.",
          prereqs: ["p1-mc"],
          resources: [
            {
              id: "p1-is:1",
        ...
        },
        {
          ...
          outcome:
            "Explain, from your own runs, why the on-policy agent walks the safe path and the off-policy agent walks the edge.",
          prereqs: ["p1-qlearning", "p1-sarsa"],
          deliverables: [
            {
              id: "p1-x-control:d1",
        ...
        },
        {
          ...
          outcome:
            "Say how many planning steps buy how much sample efficiency on a gridworld, and where the synthetic data starts to hurt.",
          landmark: true,
          prereqs: ["p1-td"],
          resources: [
            {
        ...
        },
        {
          ...
          outcome:
            "Decide whether a given environment is partially observed, and choose between stacking, recurrence and a learned latent state with a reason.",
          resources: [
            {
              id: "p1-pomdp:1",
              kind: "paper",
        ...
        },
        {
          ...
          outcome:
            "Name the three ingredients, say which one you could drop in a given agent, and predict where instability will show up in a learning curve.",
          landmark: true,
          resources: [
            {
              id: "p1-fa:1",
        ...
        },
        {
          ...
          deliverables: [
            ...
            },
            {
              id: "p1-x-triad:d2",
              label:
                "A plot of the same setup with one ingredient removed at a time (on-policy sampling, bootstrapping, function approximation)",
            },
            {
              id: "p1-x-triad:d3",
    ...
    },
    {
      ...
      problem:
        "By now you have tabular agents and learning curves. A single run tells you almost nothing: seeds alone move deep-RL results more than most method changes do, and a comparison made without a protocol is not evidence.",
      approach:
        "Seeds and spread first, then the paper that documented how fragile published results are, a protocol you write before the runs, a small study on the CliffWalking comparison you already have, and a fixed order for debugging an agent that does not learn.",
      outcome:
        "You can run a comparison whose conclusion survives someone else's rerun, and you check the usual bugs before you touch a hyperparameter.",
      from: "p1-x-control",
      path: [
        [1222, 988],
        [1222, 1118],
      ...
      stations: [
        {
          ...
          outcome:
            "Report a result as a distribution over seeds, and say how many seeds a claim of a given size needs.",
          prereqs: ["p1-x-control"],
          resources: [
            {
              id: "p1e-seeds:1",
              kind: "paper",
        ...
        },
        {
          ...
          outcome:
            "List the confounders that make two published numbers incomparable, and say which ones your own runs are exposed to.",
          resources: [
            {
              id: "p7-henderson:1",
              kind: "paper",
        ...
        },
        {
          ...
          prereqs: ["p1e-protocol", "p1-x-control"],
          deliverables: [
            {
              id: "p1e-x-study:d1",
    ...
    },
    {
      ...
      problem:
        "Tabular methods stop at problems small enough to enumerate. Replacing the table with a network brings back all three legs of the deadly triad, and Phase 1 showed you what that does to a value estimate.",
      approach:
      ...
      outcome:
        "You have a DQN you wrote and debugged, an ablation with uncertainty on it, and a working sense of which extensions matter and which are noise at your budget.",
      from: "p1-x-pg",
      path: [
        [2054, 988],
        [2262, 780],
      ...
      stations: [
        {
          ...
          outcome:
            "Implement DQN from scratch, including replay, target networks and the terminal/truncation handling, and get it learning on CartPole.",
          landmark: true,
          prereqs: ["p1-fa", "p1e-debug"],
          resources: [
            {
              id: "p2-dqn:1",
              kind: "paper",
        ...
        },
        {
          ...
          outcome:
            "Debug a value-based agent to a working state, and measure a single design change against the noise floor.",
          prereqs: ["p2-dqn"],
          deliverables: [
            {
              id: "p2-x-dqn:d1",
            ...
            },
            {
              id: "p2-x-dqn:d2",
              label:
                "One component changed (target-network period, replay capacity or exploration schedule) and measured over at least 5 seeds",
            },
            {
              id: "p2-x-dqn:d3",
        ...
        },
        {
          ...
          always: true,
          prereqs: ["p2-ddqn", "p1e-protocol", "p7-rliable"],
          deliverables: [
            {
              id: "p2-x-value:d1",
              label:
                "Double DQN plus two further components (Dueling, PER, n-step or distributional) added incrementally to one codebase",
            },
            {
              id: "p2-x-value:d2",
    ...
    },
    {
      ...
      problem:
        "Value methods pick actions by maximising over them, which fails for continuous actions and gives no direct control over how much the policy changes per update. Phase 1 left you with REINFORCE and its variance.",
      approach:
      ...
      outcome:
        "You can derive the clipped surrogate objective, implement PPO and SAC, and explain a difference between two policy-gradient runs from the code rather than from the plot.",
      from: "p1-x-pg",
      path: [
        [2054, 988],
        [2262, 1196],
      ...
      stations: [
        ...
        },
        {
          ...
          outcome:
            "Explain the bias-variance trade-off that lambda controls, and pick a value for a given episode length.",
          resources: [
            {
              id: "p3-gae:1",
              kind: "paper",
        ...
        },
        {
          ...
          outcome:
            "Estimate a KL from samples, say which direction you are penalising and why, and explain what an entropy bonus does to exploration.",
          prereqs: ["p0-maths"],
          resources: [
            {
              id: "p3-entropy:1",
        ...
        },
        {
          ...
          outcome:
            "Audit a PPO implementation against the list and say which details your version omits and what each omission costs.",
          resources: [
            {
              id: "p7-details:1",
              kind: "blog",
        ...
        },
        {
          ...
          outcome:
            "Write the clipped surrogate objective from memory and explain what the ratio and the clip range each do.",
          landmark: true,
          prereqs: ["p3-trpo"],
          resources: [
            {
        ...
        },
        {
          ...
          outcome:
            "Get PPO working on a continuous-control task and state its result with a reproducible protocol rather than a remembered number.",
          prereqs: ["p3-ppo", "p1e-protocol", "p7-details"],
          deliverables: [
            {
              id: "p3-x-ppo:d1",
              label:
                "PPO from scratch on a MuJoCo task, with the environment version, total interaction budget, evaluation episodes and seed count stated up front",
            },
            {
              id: "p3-x-ppo:d2",
            ...
            },
            {
              id: "p3-x-ppo:d3",
              label:
                "An audit against the 37 implementation details, listing which you implemented and which you skipped",
            },
            {
              id: "p3-x-ppo:d4",
        ...
        },
        {
          ...
          outcome:
            "Compare three closely related algorithms fairly, and attribute differences to specific implementation choices.",
          prereqs: ["p3-sac", "p3-td3", "p7-rliable"],
          deliverables: [
            {
    ...
    },
    {
      ...
      problem:
        "Phase 1B taught you to respect the spread. Deep agents make it worse: more seeds cost more, budgets are easier to bend, and a mean over five runs hides most of what happened.",
      approach:
        "How an RL experiment is designed so that its conclusion holds: what to control and what to tune, how runs are compared, which benchmarks and protocols the field uses, and rliable's interval estimates, performance profiles and aggregate metrics. The exercise reports one earlier comparison the way a careful paper would.",
      outcome:
        "You can design, run and report a comparison with stated budgets and honest uncertainty, and you can tell when a published gap is not worth believing.",
      from: "p2-per",
      path: [
        [2197, 481],
        [3250, 481],
      ...
      stations: [
        ...
        },
        {
          ...
          outcome:
            "Choose an interval or test appropriate to a comparison, and state the uncertainty rather than the point estimate.",
          prereqs: ["p1e-seeds"],
          resources: [],
        },
        {
        ...
        },
        {
          ...
          outcome:
            "Produce an IQM with stratified bootstrap confidence intervals and a performance profile for your own runs.",
          landmark: true,
          prereqs: ["p1e-seeds"],
          resources: [
            {
        ...
        },
        {
          ...
          prereqs: ["p7-rliable", "p1e-x-study"],
          deliverables: [
            {
              id: "p7-x-report:d1",
    ...
    },
    {
      ...
      problem:
        "Every agent so far explored by adding noise to its actions. On a task with sparse reward, Montezuma's Revenge or any long corridor, noise never finds the reward and the agent has nothing to learn from.",
      approach:
        "Intrinsic reward for novelty: pseudo-counts from density models, prediction error in a learned feature space (ICM) and against a fixed random network (RND), posterior-sampling exploration with ensembles, Go-Explore's remember-and-return, and the regret bounds that say what optimism buys in an unknown MDP.",
      outcome:
        "You can add an intrinsic reward to an existing agent, say which novelty signal suits a task and why, and recognise the noisy-TV failure when you see it.",
      track: true,
      from: "p3-a3c",
      path: [
        [1950, 1560],
      ...
      stations: [
        ...
        },
        {
          ...
          outcome:
            "Explain why a fixed random target network gives a usable novelty signal, and where intrinsic bonuses fail.",
          landmark: true,
          resources: [
            {
              id: "p6a-rnd:1",
    ...
    },
    {
      ...
      problem:
        "Model-free agents pay for every step of experience. Dyna-Q in Phase 1 showed that a learned model can multiply that experience, and also how the model's errors compound over a rollout.",
      approach:
        "Learned dynamics with uncertainty (PILCO, PETS), latent world models and policies trained inside them (World Models, PlaNet, Dreamer, DreamerV3), short model rollouts that bound compounding error (MBPO), and decision-time planning: MCTS, AlphaGo to AlphaZero, and MuZero's search over a learned model. Two exercises: learn a latent model and measure how far ahead it stays trustworthy, and implement UCT for a game.",
      outcome:
        "You can train a policy in imagination against a model-free baseline at the same budget, implement tree search, and explain what MuZero learns that AlphaZero is given.",
      track: true,
      from: "p2-x-value",
      path: [
        [390, 416],
      ...
      stations: [
        ...
        },
        {
          ...
          outcome:
            "Explain what a latent world model has to predict, and why training a controller inside it can work at all.",
          prereqs: ["p1-pomdp"],
          resources: [
            {
              id: "p4-worldmodels:1",
        ...
        },
        {
          ...
          deliverables: [
            ...
            },
            {
              id: "p4-x-model:d3",
              label:
                "A policy trained in imagination compared against a model-free baseline at equal environment interaction",
            },
            {
              id: "p4-x-model:d4",
    ...
    },
    {
      ...
      problem:
        "Everything so far assumed you can act in the environment. With a fixed dataset the agent cannot correct itself, and a Q-function queried on actions the data never took returns optimistic nonsense: the distributional-shift problem.",
      approach:
        "The tutorial that frames the problem, then the responses in order: constrain the policy to the data (BCQ), penalise out-of-distribution values (CQL), never query them (IQL), add a behaviour-cloning term (TD3+BC), and recast the problem as sequence modelling (Decision Transformer). Offline-to-online closes the loop.",
      outcome:
        "You can train an agent on a D4RL dataset, diagnose overestimation from unseen actions, and pick a conservatism mechanism suited to the data you have.",
      track: true,
      from: "p3-ddpg",
      path: [
        [949, 1560],
      ...
      stations: [
        {
          ...
          outcome:
            "State the distributional-shift problem in one sentence and say why off-policy algorithms do not solve it by default.",
          landmark: true,
          resources: [
            {
              id: "p6b-tutorial:1",
    ...
    },
    {
      ...
      problem:
        "Reward is the input every method so far has taken for granted. Many tasks have no reward you can write down but do have demonstrations of the behaviour you want.",
      approach:
        "Behaviour cloning and its compounding error, DAgger's interactive fix, MaxEnt IRL for recovering a reward under which the expert is optimal, GAIL for matching the expert's occupancy measure without a reward, and AIRL for a reward that transfers.",
      outcome:
        "You can train a policy from demonstrations, explain why cloning drifts and how DAgger stops it, and recover a reward you can hand to an RL agent.",
      track: true,
      from: "p3-npg",
      path: [
        [2197, 1495],
    ...
    },
    {
      ...
      problem:
        "A flat policy acts one primitive step at a time and learns one task. Long horizons and families of related goals both defeat it: credit has to travel too far, and every new goal starts from nothing.",
      approach:
        "Temporal abstraction through options and their end-to-end learning (Option-Critic), manager-worker hierarchies (FeUdal Networks, HIRO), and goals as inputs: universal value functions and hindsight relabelling of failed trajectories (HER).",
      outcome:
        "You can add a goal input to a value function, relabel replay so that sparse binary rewards become learnable, and say when a hierarchy is worth its extra machinery.",
      track: true,
      from: "p3-pgtheorem",
      path: [
        [2262, 1300],
    ...
    },
    {
      ...
      problem:
        "With more than one learner the environment stops being stationary: every other agent's policy is part of the dynamics, and it is changing too. Single-agent convergence arguments no longer apply.",
      approach:
        "Independent learning and its failure, centralised critics with decentralised actors (MADDPG), value factorisation (VDN, QMIX), counterfactual credit assignment (COMA), league self-play at scale (AlphaStar, OpenAI Five), and the game-theoretic line: CFR and PSRO.",
      outcome:
        "You can set up centralised training with decentralised execution, choose a credit-assignment scheme for a cooperative task, and explain what self-play needs so that it does not chase its own tail.",
      track: true,
      from: "p3-impala",
      path: [
        [1092, 1560],
    ...
    },
    {
      ...
      problem:
        "An agent trained on one task starts every new task from scratch, and one trained on one level of a game often cannot play the next. Nothing so far separates learning a task from learning how to learn tasks.",
      approach:
        "Learning to learn: an RNN that runs an RL algorithm in its activations (RL²), meta-learned initialisations (MAML), task inference on top of SAC (PEARL), algorithm distillation into a transformer, and Procgen as the benchmark that measures generalisation rather than memorisation.",
      outcome:
        "You can train an agent across a task distribution and measure adaptation on held-out tasks, and you can tell generalisation from memorisation on a benchmark.",
      track: true,
      from: "p3-trpo",
      path: [
        [1612, 1560],
    ...
    },
    {
      ...
      problem:
        "Pixel input makes every method above slower and less stable: the agent has to learn what to see before it can learn what to do, from a reward signal too weak for the job.",
      approach:
        "Auxiliary losses that give the encoder more signal, UNREAL's prediction and control tasks, CURL's contrastive loss and SPR's latent-dynamics prediction, and the finding that simple image augmentation (RAD, DrQ) gets most of the benefit on its own.",
      outcome:
        "You can add an augmentation or an auxiliary loss to a pixel agent and measure what it buys, and you know which of them the sample-efficient Atari agents depend on.",
      track: true,
      from: "p3-sac",
      path: [
        [598, 1560],
    ...
    },
    {
      ...
      problem:
        "A policy trained in simulation meets a real robot whose dynamics, sensors and latencies the simulator did not model. The reality gap turns a solved task into a failed one.",
      approach:
        "Domain randomisation as the standard bridge, automatic randomisation at scale in the Rubik's Cube work, and DayDreamer's world-model learning directly on hardware.",
      outcome:
        "You can design a randomisation scheme for a simulator and argue about what it will and will not transfer.",
      track: true,
      from: "p3-ppo",
      path: [
        [1430, 1560],
    ...
    },
    {
      ...
      problem:
        "Phase 3 gave you PPO with a reward you could write down. A language model's reward is a human preference or the correctness of an answer, and the policy is a model with billions of parameters held near a pretrained reference by a KL penalty.",
      approach:
        "Preference-based RL from Christiano through the InstructGPT recipe, direct alignment (DPO and its variants), then reasoning RL: GRPO's critic-free group baseline, verifiable rewards, the R1 and o1 results, the fixes in DAPO and Dr. GRPO, sequence-level and value-based alternatives, process rewards and agentic RL. Two exercises: train a reward model against DPO, and run GRPO with a rule-based reward.",
      outcome:
        "You can explain the three RLHF stages and what DPO removes, implement GRPO on a small model, and read a reasoning-RL paper knowing which of its choices carry the result.",
      track: true,
    ...
    },
    {
      ...
      problem:
        "A protocol written in Phase 7 can ask for more runs than one machine delivers, and most attempts to scale RL up reinvent the same handful of architectures badly.",
      approach:
        "Ape-X's many actors and one prioritised buffer, SEED RL's accelerator-side inference, and vectorised environments, which is what most small-scale distributed RL really needs.",
      outcome:
        "You can pick the throughput architecture a project actually needs, from batching environments on one GPU to actors on a cluster.",
      track: true,
      from: "p7-stats",
      path: [
        [2925, 481],
    ...
    },
    {
      ...
      problem:
        "By now you have used TD, policy gradients and exploration bonuses on faith. Their guarantees exist, and knowing where they hold tells you when an algorithm's failure is a bug and when it is a theorem.",
      approach:
        "Szepesvári's compact overview, the theory monograph on sample complexity, PAC-MDP and exploration, and the convergence results for TD with function approximation and for policy gradients.",
      outcome:
        "You can state the conditions under which the core algorithms converge, and recognise which of them your agent violates.",
      track: true,
      path: [
        [806, 156],
        {
    ...
    },
    {
      ...
      problem:
        "You can implement and evaluate. Research asks a different question: whether a published claim holds, and why not when it does not.",
      approach:
        "One claim stated precisely enough to be wrong, a bounded reproduction of its evidence, a discrepancy resolved with evidence rather than a guess, a hypothesis with a competing explanation, a protocol written before the runs, and a short honest write-up. Six exercises, no reading.",
      outcome:
        "A report on a claim you tested yourself, with uncertainty, limitations and the negative results left in: the unit of work a research group deals in.",
      from: "p7-x-report",
      path: [
        [3120, 1690],
        [3120, 1846],
  ...
  links: [
    ...
    ["p2-per", "p7-apex"],
    ["p6g-spr", "p2-bbf"],
    ["p6a-goexplore", "p2-ngu"],
    ["p3-reinforce", "p5-grpo"],
    ["p3-ppo", "p5-instructgpt"],
    ["p3-ppo", "p5-grpo"],
    ["p3-impala", "p7-seed"],
    ["p3-impala", "p6e-alphastar"],
    ["p3-ddpg", "p6g-drq"],
    ["p3-td3", "p6b-td3bc"],
    ["p3-sac", "p4-mbpo"],
    ["p3-sac", "p6f-pearl"],
    ["p6c-maxent", "p3-sac"],
    ["p4-dreamerv3", "p6h-daydreamer"],
    ["p4-muzero", "p5-o1"],
    ["p6b-dt", "p6f-ad"],
    ["p6d-her", "p6h-domrand"],
    ["p8-bandits", "p6a-pseudo"],
    ["p8-tdconv", "p1-td"],
    ["p8-pgconv", "p3-pgtheorem"],
    ["p0-sb", "p1-mc"],
    ["p0-sb", "p1-td"],
    ["p0-sb", "p1-qlearning"],
    ["p0-sb", "p1-sarsa"],
    ...
    ["p0-silver", "p1-dp"],
    ["p0-silver", "p1-mc"],
    ["p0-silver", "p1-qlearning"],
    ["p0-silver", "p1-sarsa"],
    ["p0-silver", "p1-fa"],
    ["p0-silver", "p1-pg"],
    ["p0-silver", "p4-dyna"],
    ["p0-silver", "p4-alphazero"],
    ["p0-silver", "p8-bandits"],
    ["p0-cs285", "p1-dp"],
    ["p0-cs285", "p1-fa"],
    ["p0-cs285", "p3-reinforce"],
    ["p0-cs285", "p3-a3c"],
    ["p0-cs285", "p3-trpo"],
    ["p0-cs285", "p3-sac"],
    ["p0-cs285", "p4-worldmodels"],
    ["p0-cs285", "p4-pets"],
    ["p0-cs285", "p4-mbpo"],
    ["p0-cs285", "p4-mcts"],
    ["p0-cs285", "p5-instructgpt"],
    ["p0-cs285", "p5-dpo"],
    ["p0-cs285", "p6a-pseudo"],
    ["p0-cs285", "p6b-tutorial"],
    ["p0-cs285", "p6b-cql"],
    ["p0-cs285", "p6c-bc"],
    ["p0-cs285", "p6c-maxent"],
    ["p0-cs285", "p6f-rl2"],
    ["p0-cs285", "p8-monograph"],
    ["p0-spinup", "p1-dp"],
    ["p0-spinup", "p3-reinforce"],
    ["p0-spinup", "p3-pgtheorem"],
    ["p0-spinup", "p3-trpo"],
    ["p0-spinup", "p3-ddpg"],
    ["p0-spinup", "p3-td3"],
    ["p0-spinup", "p3-sac"],
    ...
    ["p0-bootcamp", "p1-fa"],
    ["p0-bootcamp", "p2-dqn"],
    ["p0-bootcamp", "p3-reinforce"],
    ["p0-bootcamp", "p3-trpo"],
    ["p0-bootcamp", "p3-ddpg"],
    ["p0-bootcamp", "p4-dyna"],
    ["p0-bootcamp", "p6c-maxent"],
    ["p0-bootcamp", "p7-henderson"],
    ["p0-cs234", "p1-dp"],
    ["p0-cs234", "p1-td"],
    ["p0-cs234", "p1-qlearning"],
    ["p0-cs234", "p5-dpo"],
    ["p0-cs234", "p6b-tutorial"],
    ["p0-cs234", "p6e-iql"],
    ["p0-refs", "p2-rainbow"],
    ["p0-refs", "p3-x-ppo"],
    ["p0-refs", "p5-x-grpo"],
    ...
    ["p1-is", "p5-dpo"],
    ["p1-pomdp", "p2-r2d2"],
    ["p1-pomdp", "p4-worldmodels"],
    ["p1-pomdp", "p5-agentic"],
    ["p3-entropy", "p3-sac"],
    ["p3-entropy", "p5-dpo"],
    ["p4-dyna", "p4-mbpo"],
    ["p1e-debug", "p2-dqn"],
    ["p1e-seeds", "p7-rliable"],
    ["p1e-protocol", "p7-empirical"],
    ["p8-bandits", "p6a-regret"],
    ["p1-fa", "p8-tdconv"],
    ["p7-x-report", "p9-claim"],
    ["p3-x-ppo", "p7-x-report"],
    ["p0-maths", "p3-entropy"],
  ],
  spineOrder: [
    "p0",
  ...
  stages: [
    ...
    },
    {
      ...
      lines: ["p2", "p4", "p5", "p6a", "p6b", "p6c", "p6d", "p6e", "p6f", "p6g", "p6h", "p8", "pd"],
    },
    {
      id: "s7",
...
export const lineSummary = (line: Line) => `${line.goal.split(". ")[0].replace(TRAILING_PERIOD, "")}.`;

export const stationIds = (curriculum: Curriculum): Set<string> => new Set(allStations(curriculum).map((s) => s.id));
export const resourceIds = (curriculum: Curriculum): Set<string> =>
  new Set(allStations(curriculum).flatMap((s) => s.resources.map((r) => r.id)));
